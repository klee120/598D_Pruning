...
if __name__ == '__main__':
    ...
    training_args.add_argument('--model', type=str, default='fc', choices=['mlpnet','fc','conv',
    ...
    training_args.add_argument('--model-class', type=str, default='default', choices=['default','lottery','tinyimagenet','imagenet', 'mlp'],
